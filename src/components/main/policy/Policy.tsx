  ...
  return (
    <div className="container px-4 mx-auto py-8 md:py-12 lg:py-16">
      <div className="max-w-4xl mx-auto">
        {/* Main Title */}
        <h4 className="text-center font-bold text-pBlue text-3xl md:text-4xl lg:text-5xl mb-8 md:mb-12 lg:mb-16">
          {title}
        </h4>
        ...
        <div className="space-y-8 md:space-y-10 lg:space-y-12">
          {sections.map((section, idx) => (
            <section key={idx} className="space-y-3 md:space-y-4">
              <h5 className="font-semibold text-pBlue text-xl">
                {section.title}
              </h5>
        ...
        <div className="mt-10 md:mt-12 lg:mt-16 pt-6 md:pt-8 border-t border-gray-200">
          <h6 className="font-semibold text-pBlue text-xl md:text-2xl mb-4 md:mb-6">
            Core Points
          </h6>
