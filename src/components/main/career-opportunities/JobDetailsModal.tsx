        ...
        >
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 p-4 md:p-6">
            <div className="flex justify-between items-start">
              <div>
                <h5 className="font-bold text-pBlue text-xl md:text-2xl lg:text-3xl">
                  {job.title}
                </h5>
          ...
          <div className="p-4 md:p-6 space-y-6">
            ...
            {/* Description */}
            <div>
              <h6 className="font-semibold text-pBlue text-lg mb-2">Job Description</h6>
            ...
            {/* Responsibilities */}
            <div>
              <h6 className="font-semibold text-pBlue text-lg mb-3">Key Responsibilities</h6>
            ...
            {/* Requirements */}
            <div>
              <h6 className="font-semibold text-pBlue text-lg mb-3">Requirements</h6>
              <ul className="space-y-2">
            ...
            {/* Benefits */}
            <div>
              <h6 className="font-semibold text-pBlue text-lg mb-3">Benefits</h6>
              <ul className="space-y-2">
