...
const Hero = () => {
  const { data } = useFetchData(["home"], "/home");
        ...
        <div className="absolute inset-0 bg-hero-overlay z-10 flex items-center justify-center text-white">
          <div className="container px-4 mx-auto flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="max-w-3xl"
            >
              <h4 className="text-2xl md:text-4xl lg:text-7xl font-bold leading-tight">
                {heading}
              </h4>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-4 lg:gap-10 mt-7 lg:mt-12">
                {button1Name && (
                  <Link
                    href={button1Url || "#"}
