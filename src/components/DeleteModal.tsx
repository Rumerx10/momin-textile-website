...
const DeleteModal = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-md max-w-md w-full mx-4 overflow-hidden"
      ...
      >
        ...
        <div className="text-center mt-4 px-6">
          <h6 className="text-xl font-bold text-pBlue">{title}</h6>
        </div>

        <div className="text-center mt-2 px-6">
          <p className="text-pGray text-sm">
            {message} "{itemName || "this item"}"? This action cannot be undone.
          </p>
        </div>
